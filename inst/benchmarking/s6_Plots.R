...
png('figures/methodSelection.png', width = 1200*2, height = 1200, res = 300)
...
legend('bottomright', legend = c('PCR','SCC', 'MI', 'GENIE3'), bty = 'n',
       cex = 0.8, ncol = 2, pch = 15:18, col = pColors)
...
png('PR.png', width = 900*4,height = 900, res = 300)
par(mfrow=c(1,4), mar=c(3,3,2,1), mgp=c(1.8,0.5,0))
...
plot(tSCC$recall,tSCC$acc, ylim=c(0.5,1), xlim = c(0,0.9), col=pColors[1], type = 'b',
